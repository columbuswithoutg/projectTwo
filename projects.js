const projects = [
  ...
  // PHASE 2
  { id: "ironman3", title: "Iron Man 3", release: "2013-05-03", prerequisites: ["avengers1"], phase: "Phase 2", gridX: 0, gridY: 5, location: "malibu", watched: false, image: "ironman3.png" },
  { id: "thor2", title: "Thor: The Dark World", release: "2013-11-08", prerequisites: ["avengers1"], phase: "Phase 2", gridX: -1, gridY: 5, location: "london", watched: false, image: "thor2.png" },
  { id: "cap2", title: "Captain America: The Winter Soldier", release: "2014-04-04", prerequisites: ["avengers1"], phase: "Phase 2", gridX: 2, gridY: 5, location: "dc", watched: false, image: "captainAmerica2.png" },
  { id: "guardians1", title: "Guardians of the Galaxy", release: "2014-08-01", prerequisites: [], phase: "Phase 2", gridX: -2, gridY: 5, location: "xandar", watched: false, image: "gotg.png" },
  { id: "ageofultron", title: "Avengers: Age of Ultron", release: "2015-05-01", prerequisites: ["ironman3", "thor2", "cap2"], phase: "Phase 2", gridX: 0, gridY: 6, location: "sokovia", watched: false, image: "avengers2.png" },
  { id: "antman", title: "Ant-Man", release: "2015-07-17", prerequisites: ["ageofultron"], phase: "Phase 2", gridX: 3, gridY: 7, location: "sf", watched: false, image: "ant-man.png" },
  ...
  { id: "antmanwasp", title: "Ant-Man and the Wasp", release: "2018-07-06", prerequisites: ["infinitywar"], phase: "Phase 3", gridX: 2, gridY: 11, location: "sf", watched: false, image: "ant-man2.png" },
  { id: "captainmarvel", title: "Captain Marvel", release: "2019-03-08", prerequisites: ["infinitywar"], phase: "Phase 3", gridX: -1, gridY: 11, location: "hala", watched: false, image: "captainMarvel.png" },
  { id: "endgame", title: "Avengers: Endgame", release: "2019-04-26", prerequisites: ["antmanwasp", "captainmarvel"], phase: "Phase 3", gridX: 0, gridY: 12, location: "avengers-compound", watched: false, image: "avengers4.png" },
  { id: "farfromhome", title: "Spider-Man: Far From Home", release: "2019-07-02", prerequisites: ["endgame"], phase: "Phase 3", gridX: -1, gridY: 13, location: "london", watched: false, image: "spider-man2.png" },

  // PHASE 4
  { id: "wandavision", title: "WandaVision", release: "2021-01-15", prerequisites: ["endgame"], phase: "Phase 4", gridX: 0, gridY: 14, location: "nyc", watched: false, image: "wandavision.png" },
  { id: "falconws", title: "The Falcon and the Winter Soldier", release: "2021-03-19", prerequisites: ["endgame"], phase: "Phase 4", gridX: 6, gridY: 14, location: "madripoor", watched: false, image: "falconws.png" },
  { id: "loki1", title: "Loki", release: "2021-06-09", prerequisites: ["endgame"], phase: "Phase 4", gridX: -5, gridY: 14, location: "tva", watched: false, image: "loki.png" },
  { id: "blackwidow", title: "Black Widow", release: "2021-07-09", prerequisites: ["endgame"], phase: "Phase 4", gridX: 5, gridY: 14, location: "budapest", watched: false, image: "blackwidow.png" },
  { id: "shangchi", title: "Shang-Chi and the Legend of the Ten Rings", release: "2021-09-03", prerequisites: ["endgame"], phase: "Phase 4", gridX: 2, gridY: 14, location: "ta-lo", watched: false, image: "shangchi.png" },
  ...
  { id: "drstrange2", title: "Doctor Strange in the Multiverse of Madness", release: "2022-05-06", prerequisites: ["wandavision", "nowayhome"], phase: "Phase 4", gridX: -1, gridY: 16, location: "multiverse", watched: false, image: "docstrange2.png" },
  { id: "msmarvel", title: "Ms. Marvel", release: "2022-06-08", prerequisites: ["endgame"], phase: "Phase 4", gridX: 1, gridY: 16, location: "karachi", watched: false, image: "msmarvel.png" },
  { id: "thor4", title: "Thor: Love and Thunder", release: "2022-07-08", prerequisites: ["endgame"], phase: "Phase 4", gridX: -2, gridY: 16, location: "new-asgard", watched: false, image: "thor4.png" },
  { id: "shehulk", title: "She-Hulk: Attorney at Law", release: "2022-08-18", prerequisites: ["endgame", "daredevil3"], phase: "Phase 4", gridX: 3, gridY: 16, location: "nyc", watched: false, image: "shehulk.png" },
  { id: "blackpanther2", title: "Black Panther: Wakanda Forever", release: "2022-11-11", prerequisites: ["endgame"], phase: "Phase 4", gridX: 2, gridY: 17, location: "wakanda", watched: false, image: "blackPanther2.png" },
  { id: "antman3", title: "Ant-Man and the Wasp: Quantumania", release: "2023-02-17", prerequisites: ["loki1"], phase: "Phase 5", gridX: -5, gridY: 17, location: "quantum", watched: false, image: "ant-man3.png" },
  { id: "guardiansholiday", title: "The Guardians of the Galaxy Holiday Special", release: "2022-11-25", prerequisites: ["endgame"], phase: "Phase 5", gridX: -3, gridY: 17, location: "knowhere", watched: false, image: "guardians-holiday.png" },
  { id: "guardians3", title: "Guardians of the Galaxy Vol. 3", release: "2023-05-05", prerequisites: ["guardiansholiday"], phase: "Phase 5", gridX: -3, gridY: 18, location: "counter-earth", watched: false, image: "gotg3.png" },
  { id: "secretinvasion", title: "Secret Invasion", release: "2023-06-21", prerequisites: ["endgame"], phase: "Phase 4", gridX: 2, gridY: 16, location: "london", watched: false, image: "secretinvasion.png" },
  { id: "loki2", title: "Loki (Season 2)", release: "2023-10-05", prerequisites: ["loki1"], phase: "Phase 5", gridX: -6, gridY: 18, location: "tva", watched: false, image: "loki2.png" },
  { id: "themarvels", title: "The Marvels", release: "2023-11-10", prerequisites: ["msmarvel", "secretinvasion"], phase: "Phase 5", gridX: 1, gridY: 18, location: "hala", watched: false, image: "themarvels.png" },

  // PHASE 6 (released so far)
  { id: "echo", title: "Echo", release: "2024-01-10", prerequisites: ["hawkeye"], phase: "Phase 4", gridX: 4, gridY: 19, location: "nola", watched: false, image: "echo.png" },
  { id: "deadpool3", title: "Deadpool & Wolverine", release: "2024-07-26", prerequisites: ["loki2"], phase: "Phase 5", gridX: -6, gridY: 19, location: "multiverse", watched: false, image: "deadpool3.png" },
  { id: "whatif2", title: "What If...? | Season 2", release: "2023-12-22", prerequisites: ["whatif1"], phase: "Phase 5", gridX: -4, gridY: 19, location: "multiverse", watched: false, image: "whatif2.png" },
  { id: "whatif3", title: "What If...? | Season 3", release: "2024-12-22", prerequisites: ["whatif2"], phase: "Phase 6", gridX: -4, gridY: 20, location: "multiverse", watched: false, image: "whatif3.png" },
